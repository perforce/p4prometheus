...
#command_runner_tags_url="https://api.github.com/repos/willKman718/command-runner/tags"
...
if [[ "$last_command_runner_version" != "$latest_command_runner_version" ]]; then
    ...
    mv "$binary_inside_tar" "$SCRIPT_DIR/command-runner"
    chmod +x "$SCRIPT_DIR/$binary_inside_tar"
