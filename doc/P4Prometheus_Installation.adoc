...
On the monitoring server, verify Prometheus targets and dashboards after running the relevant installer. See <<_troubleshooting>> for component-specific checks.
